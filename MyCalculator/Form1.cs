...
namespace MyCalculator {
    public partial class Form1 : Form {
        ...
        {
            screen.Text = _calculator.PressMinus(screen.Text);
        }

        private void button13_Click(object sender, EventArgs e)
        {
            screen.Text = _calculator.PressMulti(screen.Text);
        }

        private void button5_Click(object sender, EventArgs e)
        {
            screen.Text = _calculator.PressDivision(screen.Text);
        }

        private void button8_Click(object sender, EventArgs e)
        {
            screen.Text = _calculator.PressPrecent(screen.Text);
        }

        private void button3_Click(object sender, EventArgs e)
        {
            screen.Text = _calculator.PressSqrt(screen.Text);
        }
    }
}
